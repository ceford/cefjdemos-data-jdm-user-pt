...
![Lista de etapas de workflow](../../../en/images/workflows/workflow/02-workflow-stages-list.png)

Selecione o nome de uma etapa para editá-la.

![Formulário de edição de etapa do workflow](../../../en/images/workflows/workflow/03-workflow-stage-edit.png)
