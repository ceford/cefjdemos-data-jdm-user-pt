<!-- Filename: Potential_backward_compatibility_issues_in_Joomla_4 / Display title: Possíveis problemas de compatibilidade com as versões anteriores no Joomla 4 -->
...
### Classes Removidas Sem Substituição
